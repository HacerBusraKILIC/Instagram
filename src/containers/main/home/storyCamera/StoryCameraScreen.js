  ...
  return (
    <View style={styles.container}>
      <RNCamera
        ...
        type={RNCamera.Constants.Type.back} //aarka kemara kullanimi saglaniyor
        ...
        onGoogleVisionBarcodesDetected={({ barcodes }) => { console.log(barcodes); }} //barkod tespiti yapmamızı 
      >
        {({ camera, status }) => {
          return (
